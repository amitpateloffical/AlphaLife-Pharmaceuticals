...
function Contact() {
  ...
  return (
    <>
      ...
      {/* <!-- Contact Start --> */}
      <div className="container-fluid section2 contact-us py-5 ">
        <div className="container ">
          <div className="row g-5 align-items-center d-flex">
            <div className="col-lg-5 wow fadeIn" data-wow-delay="0.2s">
              <div className="abouts" data-aos="fade-right">
                <img className="img-fluid" src="https://png.pngtree.com/png-vector/20220226/ourmid/pngtree-contact-us-microphone-icon-png-image_4404227.png" />
              </div>
            </div>

            <div className="container-fluid py-5 col-lg-7 ">

              <div className="container py-5 contactus-form" data-aos="fade-left">
